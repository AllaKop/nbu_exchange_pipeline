from aws.ingestion_code import nbu_exchange_api_incr_ingestion_s3
from unittest.mock import patch, MagicMock

def test_build_url():
    date = "20260202"
    url = nbu_exchange_api_incr_ingestion_s3.build_url(date)
...
def test_fetch_data_success(mock_get):
    ...
    url = nbu_exchange_api_incr_ingestion_s3.build_url("20260202")
...
def test_save_to_s3(mock_boto_client):
    ...
    nbu_exchange_api_incr_ingestion_s3.save_to_s3(mock_s3, "bucket", "key", {"a": 1})
